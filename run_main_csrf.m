...
switch data_index
    case 1
        ...
        concatenation = true;
        csrf_parameters = [20, 5; 15, 5; 20, 5; 10, 5];
    ...
    case 2
        ...
        data_views = normalize_multiview_data(data_views);
        csrf_parameters = [5, 5; 5, 10; 5, 10; 7, 10];
    ...
    case 3
        ...
        csrf_parameters = [15, 0.1; 15, 0.1; 20, 0.1; 25, 0.1];
     ...
     case 4
        ...
        data_views = normalize_multiview_data(data_views);
        concatenation = true;   
        csrf_parameters = [30, 5; 30, 0.5; 10, 5; 40, 5]; 
    ...
    case 5
        ...
        csrf_parameters = [60, 5; 75, 0.1; 55, 0.1; 75, 5];
    ...
    case 6
        ...
        data_views = normalize_multiview_data(data_views);
        csrf_parameters = [10, 0.1; 7, 0.1; 7, 0.1; 7, 0.1];
    ...
    case 7
        ...
        csrf_parameters = [10, 1; 10, 1; 7, 1; 7, 5];
    ...
    case 8
        ...
        csrf_parameters = [15, 5; 20, 5; 20, 5; 20, 1];

end

final_result = strcat(filename, '_result.txt');
final_average_result = strcat(filename, '_average_result.txt');
...
for raito_idx = 1 : length(missing_raitos)    
    ...
    kn = csrf_parameters(raito_idx, 1);
    alpha = csrf_parameters(raito_idx, 2);    

    tic;
    [L_views, H_views, Z_views, max_eigen_values] = data_preprocess(data_views, Mn, kn, K, concatenation);
